...
?>
                        <div id="add-register-member-page" class="loaded-section">
                            ...
                            <div id="actions-" class="action-buttons">
                                ...
                                <button id="update-member-<?php echo $theMember->id; ?>" class="update-member-btn" name="update-member-<?php echo $theMember->id; ?>" value="update-<?php echo $theMember->id; ?>" onclick="updateMember(<?php echo $theMember->id; ?>, <?php echo $session->user_id; ?>, 'edit')">Update</button></p>
